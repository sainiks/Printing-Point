...
export default function CategoryCard({
  ...
  return (
    <Card className="flex flex-col overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 bg-[#222A44] text-white border-border shadow-lg h-full">
